...
public class Screenshot {
	...
	public static String captureScreenshot1(WebDriver driver , String filename) throws IOException // here "WebDriver driver" will call the corresponding driver  and will be used throughout the method
	{
		TakesScreenshot scrshot =(TakesScreenshot)driver; // (TakeScreenshot)driver --> this means we are changing "driver" type from "WebDriver" to "TakeScreenshot" i.e. downcasting
